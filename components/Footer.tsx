export default function Footer() {
  ...
  <div className="max-w-3xl mx-auto text-center">
    <div className="mb-12">
      <h2 className="text-3xl font-bold mb-3">APEX Fitness</h2>
      <p className="text-gray-400 text-lg">Transform Your Body, Elevate Your Life</p>
    </div>
    ...
    <div className="border-t border-slate-800 pt-8">
      <p className="text-gray-400 text-sm mb-2">&copy; 2025 APEX Fitness. All rights reserved.</p>
